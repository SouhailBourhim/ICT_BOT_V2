...
case $choice in
    1)
        ...
        echo "📊 Analytics dashboard: http://localhost:8501/analytics"
        echo "🧮 Math rendering and enhanced chat features enabled"
        echo "💬 Conversation management with persistence"
        echo "📄 Advanced document processing pipeline"
        echo ""
    ...
    2)
        ...
        echo "📱 Access the app at: http://localhost:8501"
        echo "📊 Analytics dashboard: http://localhost:8501/analytics"
        echo "🔒 Production mode with security hardening"
